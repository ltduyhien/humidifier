...
public class OpenWeather {
    ...
    private static final String OPEN_WEATHER_MAP_API = "a7bcdda871e16cc75af5b65dd7c9c38d"; // my private OpenWeather API key
        ...
        protected void onPostExecute(JSONObject json) {
            try {
                if(json != null){
                    ...
                    String temperature = String.format("%d", (int) main.getDouble("temp"))+ "°";
